...
type MsgTestLoan struct {
	Creator string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	Id      uint64 `protobuf:"varint,2,opt,name=id,proto3" json:"id,omitempty"`
}

func (m *MsgTestLoan) Reset()         { *m = MsgTestLoan{} }
func (m *MsgTestLoan) String() string { return proto.CompactTextString(m) }
func (*MsgTestLoan) ProtoMessage()    {}
func (*MsgTestLoan) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8f8f93b4237d328, []int{10}
}
func (m *MsgTestLoan) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgTestLoan) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgTestLoan.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgTestLoan) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgTestLoan.Merge(m, src)
}
func (m *MsgTestLoan) XXX_Size() int {
	return m.Size()
}
func (m *MsgTestLoan) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgTestLoan.DiscardUnknown(m)
}

var xxx_messageInfo_MsgTestLoan proto.InternalMessageInfo

func (m *MsgTestLoan) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *MsgTestLoan) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
type MsgTestLoanResponse struct {
}

func (m *MsgTestLoanResponse) Reset()         { *m = MsgTestLoanResponse{} }
func (m *MsgTestLoanResponse) String() string { return proto.CompactTextString(m) }
func (*MsgTestLoanResponse) ProtoMessage()    {}
func (*MsgTestLoanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8f8f93b4237d328, []int{11}
}
func (m *MsgTestLoanResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgTestLoanResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgTestLoanResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgTestLoanResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgTestLoanResponse.Merge(m, src)
}
func (m *MsgTestLoanResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgTestLoanResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgTestLoanResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgTestLoanResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgTestLoan)(nil), "username.loan.loan.MsgTestLoan")
	proto.RegisterType((*MsgTestLoanResponse)(nil), "username.loan.loan.MsgTestLoanResponse")
}
...
var fileDescriptor_b8f8f93b4237d328 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	TestLoan(ctx context.Context, in *MsgTestLoan, opts ...grpc.CallOption) (*MsgTestLoanResponse, error)
}
...
func (c *msgClient) TestLoan(ctx context.Context, in *MsgTestLoan, opts ...grpc.CallOption) (*MsgTestLoanResponse, error) {
	out := new(MsgTestLoanResponse)
	err := c.cc.Invoke(ctx, "/username.loan.loan.Msg/TestLoan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	TestLoan(context.Context, *MsgTestLoan) (*MsgTestLoanResponse, error)
}
...
func (*UnimplementedMsgServer) TestLoan(ctx context.Context, req *MsgTestLoan) (*MsgTestLoanResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TestLoan not implemented")
}
...
func _Msg_TestLoan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgTestLoan)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).TestLoan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/username.loan.loan.Msg/TestLoan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).TestLoan(ctx, req.(*MsgTestLoan))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *MsgTestLoan) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgTestLoan) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgTestLoan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgTestLoanResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgTestLoanResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgTestLoanResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgTestLoanResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgTestLoan) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgTestLoan: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgTestLoan: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgTestLoanResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgTestLoanResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgTestLoanResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
